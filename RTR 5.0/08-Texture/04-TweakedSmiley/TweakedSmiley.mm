...
{
    // variable declarations
    GLfloat square_texture_coordinates[8];
    ...
    glBindBuffer(GL_ARRAY_BUFFER, vbo_texture_coordinates_square);
    glBufferData(GL_ARRAY_BUFFER, sizeof(square_texture_coordinates), square_texture_coordinates, GL_DYNAMIC_DRAW);
    glBindBuffer(GL_ARRAY_BUFFER, 0);
