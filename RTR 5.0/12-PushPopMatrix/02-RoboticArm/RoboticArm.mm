...
- (void)display
{
   ...
   glUseProgram(shaderProgramObject);
	...
	mat4 translationMatrix = vmath::translate(0.0f, 0.0f, -7.5f);
	mat4 rotationMatrixShoulder = vmath::rotate((float)shoulder, 0.0f, 0.0f, 1.0f);
	mat4 modelViewMatrix = rotationMatrixShoulder * translationMatrix;

	s.push(modelViewMatrix);
	{
		mat4 scaleMatrix = vmath::scale(2.0f, 0.5f, 1.0f);
	...
	modelViewMatrix = s.top();
	s.pop();

	// do transformations for forearm in current
	translationMatrix = vmath::translate(1.0f, 0.0f, 0.0f);
	mat4 rotationMatrixElbow = vmath::rotate((float)elbow, 0.0f, 0.0f, 1.0f);
	modelViewMatrix = modelViewMatrix * translationMatrix * rotationMatrixElbow * translationMatrix;
	s.push(modelViewMatrix);
	{
		mat4 scaleMatrix = vmath::scale(2.0f, 0.5f, 1.0f);
		modelViewMatrix = modelViewMatrix * scaleMatrix;
	...
	translationMatrix = vmath::translate(0.75f, 0.0f, 0.0f);
	mat4 rotationMatrixWrist = vmath::rotate((float)wrist, 0.0f, 0.0f, 1.0f);
	modelViewMatrix = modelViewMatrix * translationMatrix * rotationMatrixWrist * translationMatrix;
	s.push(modelViewMatrix);
	{
		mat4 scaleMatrix = vmath::scale(0.75f, 0.5f, 1.0f);
		modelViewMatrix = modelViewMatrix * scaleMatrix;
