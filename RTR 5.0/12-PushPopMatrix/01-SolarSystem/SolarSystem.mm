...
- (void)display
{
    ...
    glUseProgram(shaderProgramObject);
        ...
        s.push(modelViewMatrix);
        {
            ...
            mat4 rotationDay = vmath::rotate((float)day, 0.0f, 1.0f, 0.0f);
            mat4 rotationYear = vmath::rotate((float)year, 0.0f, 1.0f, 0.0f);
            //mat4 rotationAxis = vmath::rotate((float)90, 1.0f, 0.0f, 0.0f);
            scaleMatrix = vmath::scale(1.0f, 1.0f, 1.0f);
            modelViewMatrix = modelViewMatrix * rotationYear * translationMatrix * rotationDay * scaleMatrix;
            ...
            //rotationAxis = vmath::rotate((float)90, 0.0f, 1.0f, 0.0f);
            modelViewMatrix = modelViewMatrix * translationMatrix * scaleMatrix;// * rotationAxis;
