...
- (int)initialize
{
    ...
    // vao_rectangle - vertex array object
...
- (void)display
{
    ...
    glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, vbo_index_rectangle);
    glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, 0); // indices.size(), indices[0] type, indices start from
    glBindVertexArray(0);
